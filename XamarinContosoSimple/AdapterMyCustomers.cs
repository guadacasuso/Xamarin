...
namespace EvolveListView {
	...
	/// Demo 5: Add an index
	/// </summary>		
	public class AdapterMyCustomers: BaseAdapter<Customer>, ISectionIndexer 
	{
		private List<Customer> data;
		private Activity context;
		
		public AdapterMyCustomers(Activity activity, IEnumerable<Customer> speakers) 
		{
		...
		//TODO: Demo5: this code sets up the indexer
		// -- ISectionIndexer --
