...
namespace AMSClients.Style
{
    public static class Colours
    {
        ...
        public static Color NegativeBackground = Color.FromHsla(Color.Blue.Hue, 1.0, 0.75);
        public static Color BackgroundGrey = Color.FromRgb(200, 200, 200);
        public static Color PositiveBalance = Color.FromRgb(54, 64, 33);
        public static Color NegativeBalance = Color.FromRgb(100, 15, 51);
